...
ScrollDown
;;===============================================================================
;; IF GRAVITY_ENABLED = 0 THEN SPRITE IS ON A LADDER: SCREEN STOPS SCROLLING
;;===============================================================================
;        lda GRAVITY_ENABLED
;        cmp #0
;        beq @canScrollDown
;;===============================================================================
;; IF GRAVITY_ENABLED = 1 THEN SPRITE IS TRAVELING DOWN (OR DIAGONALLY)
;;===============================================================================
;        cmp #1
;        beq @PoleCollis
;        rts
...
;;===============================================================================
;; CHECK IF SPRITE HIT A POLE WHILE TRAVELING DOWN (OR DIAGONALLY)
;;===============================================================================
;@PoleCollis
;        ldx #1                            
;        jsr CheckBlockUnder              
;        lda COLLIDER_ATTR
;        cmp #COLL_POLE
;        beq @stopScrollDown                       ; No, player keeps falling

;;===============================================================================
;; CHECK IF SPRITE HIT THE FLOOR WHILE TRAVELING DOWN (OR DIAGONALLY)
;;===============================================================================
;@FloorCollis
;        ldx #1                            
;        jsr CheckBlockUnder              
;        lda COLLIDER_ATTR
;        cmp #COLL_FLOOR
;        bne @canScrollDown                       ; No, player keeps falling
...
;        lda COLLIDER_ATTR
;        cmp #COLL_POLE
;        bne @FloorCollis                       ; No, player keeps falling
;        rts
...
;        lda COLLIDER_ATTR
;        cmp #COLL_FLOOR
;        bne @canScrollLeft                       ; No, player keeps falling
;        rts
...
@frame0
        ...
        sbc #1
        and #%00000011                          ; mask it's value to 0-3
...
;        lda COLLIDER_ATTR
;        cmp #COLL_FLOOR
;        bne @canScrollRight                       ; No, player keeps falling
;        rts
